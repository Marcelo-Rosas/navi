-- Migration 2: Recreate all necessary triggers

-- 1. on_auth_user_created: create profile and role for new users
...
-- 3. update_conversation_last_message_trigger
...
-- 4. ensure_single_default_instance
